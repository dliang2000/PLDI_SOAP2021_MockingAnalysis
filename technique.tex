...
\item Although we have manually categorized collection APIs and mock APIs, it is possible that our enumeration is incomplete, leading to false negatives.
  ...
  Our approach cannot detect when subjects build their own mocks; however, those are more likely to be stubs or fakes than true mocks~\cite{fowler07:_mocks_arent_stubs}. 
