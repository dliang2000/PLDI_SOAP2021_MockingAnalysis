...
\end{itemize}
We are also vulnerable to false negatives (threatening soundness) from missed collection APIs and mock APIs. False positives (threatening precision) occur from the approximations above.
