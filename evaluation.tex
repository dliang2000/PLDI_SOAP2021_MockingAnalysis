...
We have implemented counters in merge function to quantify the possible source of imprecision from incoming branches in our may-analysis. Among the 1,084 test-related methods that contains intraprocedural mocks, 23 of them uses conditionals, loops or try-catch blocks.  Manual inspections suggest that % ... to be added
