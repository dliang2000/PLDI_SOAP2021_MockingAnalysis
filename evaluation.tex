...
\paragraph{RQ1} We look into 1565 benchmarks obtained from the Duets dataset~\cite{durieux2021duets} and observe the usage frequency 
of mock objects from 3 common mocking libraries EasyMock , Mockito and PowerMock. Our findings corroborate findings from 
previous studies. \todo[inline]{cite based on related work} We also look at the contribution of mocks to coverage, which is further 
discussed in Section~\ref{sec:coverage}
...
\todo[inline]{fit this in with the rest of the section, talk about the actual numbers}
